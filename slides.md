...
<p>Tenemos más de 5 años de experiencia con <strong>GTFS</strong> <i>Schedule</i> y <strong>GTFS</strong> <i>Realtime</i> en sitios web y Google Maps.</p>
</div>
<div class="flex items-center justify-center text-center">
<p>Somos miembros académicos de <strong>MobilityData</strong>, la organización internacional que dirige su evolución.</p>
</div>
<div class="flex items-center justify-center text-center">
<p>Desarrollamos herramientas informáticas especializadas para su procesamiento y análisis.</p>
</div>
</div>
...
<div class="flex flex-col items-center justify-center h-full gap-8">
<img src="/images/infobus_white.png" width="250px" alt="Logo Infobús">
<div class="grid grid-cols-4 gap-6 w-full">
<div class="flex flex-col items-center text-center">
<material-symbols-feed class="text-4xl mb-3" />
<p>Recolección de <em>feeds</em> (suministros de datos) de <strong>GTFS</strong> de diferentes sistemas de transporte.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-database class="text-4xl mb-3" />
<p>Almacenamiento de datos históricos en bases de datos especializadas.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-analytics class="text-4xl mb-3" />
<p>Análisis de datos para optimización, investigación o regulación del servicio.</p>
</div>
<div class="flex flex-col items-center text-center">
...
<div class="flex flex-col items-center justify-center h-full gap-8">
<img src="/images/infobus_admin_white.png" width="400px" alt="Logo Infobús">
<div class="grid grid-cols-3 gap-6 w-full">
<div class="flex flex-col items-center text-center">
<material-symbols-edit class="text-4xl mb-3" />
<p>Interfaz web para la edición de <strong>GTFS</strong> <em>Schedule</em>.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-verified class="text-4xl mb-3" />
<p>Validación de datos y estimación de tiempos de llegada.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-query-stats class="text-4xl mb-3" />
<p>Análisis de métricas de desempeño del servicio.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-dashboard-customize class="text-4xl mb-3" />
<p>Gestión de contenidos de los canales de comunicación.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-science class="text-4xl mb-3" />
<p>Simulación de datos de transporte para pruebas.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-draw class="text-4xl mb-3" />
<p>Rotulación automatizada con los datos y los diseños oficiales.</p>
</div>
</div>
</div>
...
<div class="flex flex-col items-center justify-center h-full gap-8">
<img src="/images/databus_admin_white.png" width="400px" alt="Logo Databús">
<div class="grid grid-cols-5 gap-6 w-full">
<div class="flex flex-col items-center text-center">
<material-symbols-monitor-heart class="text-4xl" />
<p class="text-sm">Monitoreo del desempeño de la infraestructura digital del sistema.</p>
</div>
<div class="flex flex-col items-center text-center">
<material-symbols-shield-lock class="text-4xl" />
<p class="text-sm">Atención de amenazas de seguridad y medidas de contingencia contra ataques.</p>
</div>
<div class="flex flex-col items-center text-center">
<simple-icons-python class="text-4xl" />
<p class="text-sm">Herramientas para Python, usado en la orquestación de procesos, análisis de datos e inteligencia artificial.</p>
</div>
<div class="flex flex-col items-center text-center">
<simple-icons-typescript class="text-4xl" />
<p class="text-sm">Herramientas para TypeScript, usado en interfaces web y aplicaciones móviles.</p>
</div>
<div class="flex flex-col items-center text-center">
...
<p>Propuesta basada en normas, especificaciones y estándares internacionales.</p>
</div>
<div class="border border-white rounded-lg p-4">
...
<p>Propuesta de la Escuela de Ingeniería Eléctrica UCR en alianza con otras <strong>instancias especializadas</strong>.</p>
</div>
<div class="border border-white rounded-lg p-4">
...
<p>Uso en la comunidad nacional e internacional por medio de proyectos de código abierto.</p>
</div>
</div>
